...
class ClienteController {
    ...
    crearSolicitud(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(aux);
            yield database_1.default.query("INSERT INTO TICKET VALUES (20," + parseInt(req.body.cod_t_ticket) + "," + parseInt(req.body.cod_dominio) + ",1,'" + req.body.descripcion + "',NULL," + req.body.cedula + ",NULL)");
